...
func (p Payment) Validate() error {
	return validation.ValidateStruct(&p,
		//validation.Field(&p.OrganisationId, validation.Required, validation.Length(1, 255)),
		//validation.Field(&p.Type, validation.Required, validation.Length(1, 255)),
		//validation.Field(&p.Version, validation.Required, validation.Min(0)),
		validation.Field(&p.Attributes, validation.Required),
	)
	return nil
}
